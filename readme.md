...
1. **京东会场 h5**
    京东大促活动 h5 会场活动页面，包括 618，双十一等高流量活动。技术栈：react.js + redux
    1. 根据业务需求定制开发活动会场页面

2. **ELF 框架**
    针对京东大促会场的特点开发的一套可快速迭代，复用的框架。
    1. 针对业务进行分析设计架构
    2. 以配置项的形式对业务组件进行声明及导出，使得关注点分离，组件内仅关注业务功能及 UI，方便不同会场复用。
    3. 开发固化模板，减少开发人力，提高效率
    4. 封装常用组件及方法
    5. 优化性能，减少首屏加载时间
    6. 编写 cli，在终端可直接下载创建新的项目，并可以随时更新线上版本。
